...
public class gestorTXT {
    ...
    public void writeTXT(String location, Vector<Vector<String>> sheet, String tempName) throws IOException {
    ...
    public Vector<Vector<String>> readTXT(String location) throws IOException {   //not sure
    ...
    public boolean deleteTXT(String fileName) {
        if (exists(fileName)) {
